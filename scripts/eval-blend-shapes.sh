...
python src/eval_blend_shapes.py --indir data/test --outdir evaluation/fft-strands-pca-test/ --bsdir data/blend-shapes/fft-strands-blend-shapes.npz --n_coeff 64 --save_strands true
python src/eval_blend_shapes.py --indir data/test --outdir evaluation/strands-pca-test/ --bsdir data/blend-shapes/strands-blend-shapes.npz --n_coeff 64 --save_strands true