...
from . import hair_reconstruction
...
# ----------------------------------------------------------------------------
# Metrics designed for hair modeling.


@register_metric
def hair_recon(opts):
    # opts.dataset_kwargs.update(max_size=None, xflip=False)
    pos, cur = hair_reconstruction.compute_stats_for_hair_reconstruction(opts, capture_all=True)
    return dict(pos=pos, cur=cur)
