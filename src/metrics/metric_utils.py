...
class MetricOptions:
    def __init__(self, G=None, G_kwargs={}, dataset_kwargs={}, hair_roots_kwargs={}, hair_type='original', output_texture=True, output_geometry=False, output_dir=None, num_gpus=1, rank=0, device=None, progress=None, cache=True):
        assert 0 <= rank < num_gpus
        self.G = G
        self.G_kwargs = dnnlib.EasyDict(G_kwargs)
        self.dataset_kwargs = dnnlib.EasyDict(dataset_kwargs)
        self.hair_roots_kwargs = dnnlib.EasyDict(hair_roots_kwargs)
