"""
Code adapted from: https://github.com/CompVis/latent-diffusion/blob/main/ldm/modules/attention.py
"""
...
from models.nn import checkpoint, zero_module, normalization
...
class SpatialTransformer(nn.Module):
    ...
    def __init__(self, in_channels, n_heads, d_head, depth=1, dropout=0., context_dim=None):
        ...
        self.proj_in = nn.Conv2d(in_channels,
                                 ...
                                 stride=1,
                                 padding=0)
        # self.ctx_encoder = SpatialRescaler(n_stages=2, in_channels=context_dim, out_channels=context_dim)
    ...
    def forward(self, x, context=None):
        ...
        ctx = rearrange(context, 'b c h w -> b (h w) c')
